...
fn protocol_matches_event(p: &Protocol, ev: &DexEvent) -> bool {
    match (p, ev) {
        ...
        | (Protocol::RaydiumClmm, DexEvent::RaydiumClmmLiquidityChangeEvent(_))
        | (Protocol::RaydiumClmm, DexEvent::RaydiumClmmConfigChangeEvent(_))
        | (Protocol::RaydiumClmm, DexEvent::RaydiumClmmCreatePersonalPositionEvent(_))
        | (Protocol::RaydiumClmm, DexEvent::RaydiumClmmLiquidityCalculateEvent(_))
        | (Protocol::RaydiumClmm, DexEvent::RaydiumClmmOpenLimitOrderEvent(_))
        | (Protocol::RaydiumClmm, DexEvent::RaydiumClmmIncreaseLimitOrderEvent(_))
        | (Protocol::RaydiumClmm, DexEvent::RaydiumClmmDecreaseLimitOrderEvent(_))
        | (Protocol::RaydiumClmm, DexEvent::RaydiumClmmSettleLimitOrderEvent(_))
        | (Protocol::RaydiumClmm, DexEvent::RaydiumClmmUpdateRewardInfosEvent(_))
