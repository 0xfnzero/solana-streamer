...
pub(crate) fn meteora_damm_v2_swap_from_parser(
    ...
    MeteoraDammV2SwapEvent {
        ...
        excluded_fee_input_amount: e.excluded_fee_input_amount,
        amount_left: e.amount_left,
        output_amount: e.output_amount,
        next_sqrt_price: e.next_sqrt_price,
        trading_fee: e.lp_fee,
        claiming_fee: e.claiming_fee,
        compounding_fee: e.compounding_fee,
        protocol_fee: e.protocol_fee,
        partner_fee: e.partner_fee,
        referral_fee: e.referral_fee,
        included_transfer_fee_amount_in: e.included_transfer_fee_amount_in,
        included_transfer_fee_amount_out: e.included_transfer_fee_amount_out,
        excluded_transfer_fee_amount_out: e.excluded_transfer_fee_amount_out,
        current_timestamp: e.current_timestamp,
        reserve_a_amount: e.reserve_a_amount,
        reserve_b_amount: e.reserve_b_amount,
        pool_authority: e.pool_authority,
