...
pub enum DexEvent {
    ...
    RaydiumClmmLiquidityChangeEvent(RaydiumClmmLiquidityChangeEvent),
    RaydiumClmmConfigChangeEvent(RaydiumClmmConfigChangeEvent),
    RaydiumClmmCreatePersonalPositionEvent(RaydiumClmmCreatePersonalPositionEvent),
    RaydiumClmmLiquidityCalculateEvent(RaydiumClmmLiquidityCalculateEvent),
    RaydiumClmmOpenLimitOrderEvent(RaydiumClmmOpenLimitOrderEvent),
    RaydiumClmmIncreaseLimitOrderEvent(RaydiumClmmIncreaseLimitOrderEvent),
    RaydiumClmmDecreaseLimitOrderEvent(RaydiumClmmDecreaseLimitOrderEvent),
    RaydiumClmmSettleLimitOrderEvent(RaydiumClmmSettleLimitOrderEvent),
    RaydiumClmmUpdateRewardInfosEvent(RaydiumClmmUpdateRewardInfosEvent),
    ...
    MeteoraDammV2UpdateDelegatePermissionEvent(MeteoraDammV2UpdateDelegatePermissionEvent),
    MeteoraDammV2WithdrawDeadLiquidityRewardEvent(MeteoraDammV2WithdrawDeadLiquidityRewardEvent),
    MeteoraDammV2CreateConfigEvent(MeteoraDammV2CreateConfigEvent),
    MeteoraDammV2CreateDynamicConfigEvent(MeteoraDammV2CreateDynamicConfigEvent),
